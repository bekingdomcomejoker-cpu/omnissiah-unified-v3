...
import { LayoutDashboard, LogOut, PanelLeft, Users, Shield, Zap, Globe, Cpu, Terminal, Sparkles, BarChart3, Swords, Map, MessageSquare } from "lucide-react";
...
const menuItems = [
  ...
  { icon: MessageSquare, label: "Master Debater", path: "/debate" },
