            ...
            <div className="max-w-4xl mx-auto text-center space-y-8">
              ...
              >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  onClick={() => window.location.href = "/axiom-gate"}
                  className="rounded-none border-orange-500/50 text-orange-400 hover:bg-orange-500/10 font-terminal text-xs tracking-widest h-12 px-8"
                >
                  AXIOM GATE v2.0
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  onClick={() => window.location.href = "/consensus-dashboard"}
                  className="rounded-none border-orange-500/50 text-orange-400 hover:bg-orange-500/10 font-terminal text-xs tracking-widest h-12 px-8"
                >
                  OMEGA CONSENSUS
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  onClick={() => window.location.href = "/specialization-dashboard"}
                  className="rounded-none border-orange-500/50 text-orange-400 hover:bg-orange-500/10 font-terminal text-xs tracking-widest h-12 px-8"
                >
                  SPECIALIZATION
                </Button>
                <Button
                  size="lg"
                  variant="outline"
                  onClick={() => window.location.href = "/save-the-wire"}
                  className="rounded-none border-blue-500/50 text-blue-400 hover:bg-blue-500/10 font-terminal text-xs tracking-widest h-12 px-8"
                >
                  SAVE THE WIRE
                </Button>
                <Button
